...
document.getElementById('login-button').addEventListener('click', (e) => {
    ...
    let phonenumber = document.getElementById('PhonenumberLogin').value;
    ...
    if (
        ...
        PopupError('Bạn chưa nhập phonenumber và mật khẩu đăng nhập!');
        return;
    }
    ...
    $.ajax({
        ...
        error: (error) => {
            console.log(error);
            PopupError(error.responseJSON.data);
        },
    });
});
